...
%define lib_ver       1.0.6
%define lib_gitver    1.0.6
%define lib_semver    1.0.6
%define lib_dist      0
...
Source0:        https://github.com/Inochi2D/inmath/archive/refs/tags/v%{lib_gitver}/inmath-%{lib_gitver}.tar.gz
