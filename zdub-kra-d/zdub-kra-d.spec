...
%define lib_ver       0.5.5
%define lib_gitver    0.5.5
%define lib_semver    0.5.5
%define lib_dist      0
...
Source0:        https://github.com/Inochi2D/kra-d/archive/refs/tags/v%{lib_gitver}/kra-d-%{lib_gitver}.tar.gz
