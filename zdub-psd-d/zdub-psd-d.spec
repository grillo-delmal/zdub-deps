...
%define lib_ver       0.6.3
%define lib_gitver    0.6.3
%define lib_semver    0.6.3
%define lib_dist      0
...
Source0:        https://github.com/Inochi2D/psd-d/archive/refs/tags/v%{lib_gitver}/psd-d-%{lib_gitver}.tar.gz
